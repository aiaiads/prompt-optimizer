...
| `template/` | 提示词模板管理、CSP 安全处理器、多语言支持。内置模板位于 `packages/core/src/services/template/default-templates/` | `TemplateManager`, `TemplateProcessor`, `StaticLoader` |
...
| `evaluation/` | 提示词评估服务，支持打分、修复建议导出为 Patch | `EvaluationService` |
